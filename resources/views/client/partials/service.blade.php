    ...
    <div class="container-lg py-5">
        ...
        <div class="row py-5">
            <div class="col-md-6">
                <div class="service-item bg-dark d-flex px-4 py-5 shadow-sm">
                    <div class="service-item-img">
                        <img src="{{asset('dist/images/service/reverse-engineering.png')}}" height="80" width="80" alt="">
                    </div>
                ...
                <div class="service-item bg-primary d-flex px-4 py-5 shadow-sm mt-4">
                    <div class="service-item-img">
                        <img src=" {{asset('dist/images/service/modern-house (1).png')}} " height="80" width="80" alt="">
                    </div>
                    <div class="service-item-text pe-4">
                        <h2 class="text-white fs-3 mb-3">ساخت و ساز</h2>
                        <p class="text-white fs-6 mb-3">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از
                ...
                <div class="service-item bg-light d-flex px-4 py-5 shadow-sm mt-4">
                    <div class="service-item-img">
                        <img src="{{asset('dist/images/service/engineer.png')}}  " height="80" width="80" alt="">
                    </div>
                    <div class="service-item-text pe-4">
            ...
            <div class="col-md-6 d-flex mt-4 mt-md-0">
                <div class="service-img w-100" style="background-image: url('{{asset("dist/images/service.webp")}}');"></div>
            </div>
        </div>
    </div>
</section>
