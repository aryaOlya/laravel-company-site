<footer class="footer pt-5">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 mt-5 mt-lg-0">
                <div class="footer-about">
                    <h5 class="fw-bold text-white">شرکت ساختمانی آریا علیا</h5>
                ...
                <div class="footer-service">
                    ...
                    <div class="footer-service-item d-flex mt-3">
                        <div class="footer-service-img">
                            <img src="{{asset('dist/images/service/service-item/1.webp')}}"  alt="">
                        </div>
                    ...
                    <div class="footer-service-item d-flex mt-3">
                        <div class="footer-service-img">
                            <img src="{{asset('dist/images/service/service-item/2.webp')}} "  alt="">
                        </div>
                        <div class="footer-service-text pe-3">
                            <h5><a href="" class="text-white fs-6">این خیلی فوق العاده است و زیباست</a></h5>
                            <div class="footer-service-author text-primary mt-4">
                    ...
                    <div class="footer-service-item d-flex mt-3">
                        <div class="footer-service-img">
                            <img src="{{asset('dist/images/service/service-item/3.webp')}} "  alt="">
                        </div>
                        <div class="footer-service-text pe-3">
                            <h5><a href="" class="text-white fs-6">این خیلی فوق العاده است و زیباست</a></h5>
                            <div class="footer-service-author text-primary mt-4">
            ...
            <div class="col-lg-2 col-md-6 mt-5 mt-lg-0">
                <div class="footer-question">
                    ...
                    <ul>
                        <li class="d-flex mt-3"><i class="fas fa-map text-primary"></i> <h5 class="text-white fs-6 pe-2">تهران تهران</h5></li>
                        <li class="d-flex mt-3"><i class="fas fa-phone text-primary"></i><h5 class="text-white fs-6 pe-2">09380524172</h5></li>
                        <li class="d-flex mt-3"><i class="fas fa-envelope text-primary"></i><h5 class="text-white fs-6 pe-2">arya.olya9978@gmail.com</h5></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="copy-right">
        <p>&copy; تمامی حقوق مادی و معنوی این وب سایت متعلق به آریا علیا میباشد.</p>
    </div>
